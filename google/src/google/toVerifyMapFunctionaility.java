...
public class toVerifyMapFunctionaility {
	...
	public static void main(String[] args) throws EncryptedDocumentException, IOException {
        ...
        driver.findElement(By.id("searchboxinput")).sendKeys("Noida");
        driver.findElement(By.xpath("//button[@id=\"searchbox-searchbutton\"]")).click();
        String text_value = driver.findElement(By.xpath("//h1[text()='Noida']")).getText();
       

       if(text_value.contains("Noida"))
       {
