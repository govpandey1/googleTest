...
public class verifyNewsFunctionality {
	...
	public static void main(String[] args) throws EncryptedDocumentException, IOException {
        ...
        driver.findElement(By.xpath("//input[@aria-label=\"Search for topics, locations & sources\"]")).sendKeys("train accident");
        driver.findElement(By.xpath("//button[@aria-label=\"Search\"]")).click();
        String news_text = driver.findElement(By.partialLinkText("train")).getText();


       if(news_text.contains("train"))
       {
